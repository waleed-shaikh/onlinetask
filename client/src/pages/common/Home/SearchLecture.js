        ...
        {lecture && <div className="mb-4 bg-secondary pb-3 pt-3">
            <div className="">
                <div className="d-flex justify-start flex-row position-relative">
                    <img className="ms-3 border rounded-2" src={lecture?.course.image} alt="loading" style={{width: '25%'}}/>
                    <div className="d-flex flex-column justify-center ps-4">
                        ...
                        <h1 className="text-md">Batch : {lecture.batche? lecture?.batche : 'morning'}</h1>
